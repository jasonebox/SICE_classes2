...
for datex in dates:
    ...
    features = ["dry_snow", "melted_snow", "flooded_snow","red_snow","bright_ice", "dark_ice", "purple_ice"] #, "lakes"]
    ...
    for i, feature in enumerate(features):
        ROI_file=f"{path_ROI}{region_name}/{year}/{datex}/{datex}_{feature}.shp"
    ...
    print('Model Predict, takes 0.5 to 3 minutes')
    ...
    print('elapsed time all:', time.strftime("%H:%M:%S", time.gmtime(elapsed_time)))
