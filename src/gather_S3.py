...
for year in years:
    ...
    # bands = ["r_TOA_01", "r_TOA_06", "r_TOA_08", "r_TOA_17", "r_TOA_21",'albedo_bb_planar_sw']
    # bands = ["r_TOA_05"]
    ...
    for d in dates:
        ...
        for var in bands:
            ...
            if not(test_file.is_file()):
                try:
                    ds = xr.open_dataset(f'https://thredds.geus.dk/thredds/dodsC/SICE_500m/Greenland/{DATASET_ID}')
                    print(var)
